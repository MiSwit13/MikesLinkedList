package com.solitarymonk.core;


import com.solitarymonk.course.Course;
import com.solitarymonk.course.CourseRepository;
import com.solitarymonk.review.Review;
import com.solitarymonk.user.User;
import com.solitarymonk.user.UserRepository;
...
public class DatabaseLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        users.save(new User("Mike", "Switzer", "miswit", "1234", new String[] {"ROLE_USER", "ROLE_ADMIN"}));
