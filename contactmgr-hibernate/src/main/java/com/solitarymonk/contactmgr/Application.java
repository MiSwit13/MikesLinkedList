package com.solitarymonk.contactmgr;

import com.solitarymonk.contactmgr.model.Contact;
import com.solitarymonk.contactmgr.model.Contact.ContactBuilder;
...
public class Application {
    ...
    public static void main(String[] args) {
        Contact contact = new ContactBuilder("Mike", "Switzer")
                .withEmail("mike@example.con")
                .withPhone(1015551212L)
                .build();
        int id = save(contact);
